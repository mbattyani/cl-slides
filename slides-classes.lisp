...
(prog1
    (meta-level:defclass slides-user
                         ...
                         ((user-name :value-type string :user-name (make-instance 'meta-level:translated-string :en "User name") :choices (list) :visible t :modifiable-groups '(:owner) :new-objects-first nil :sql-length 0 :nb-decimals 0 :get-value-sql "" :view-type :default)
                          ...
                          (presentations :value-type presentation :user-name (make-instance 'meta-level:translated-string :en "Presentations") :choices (list) :visible t :modifiable-groups '(:author) :list-of-values t :new-objects-first nil :sql-length 0 :nb-decimals 0 :can-create-new-object t :get-value-sql "" :view-type :default))
